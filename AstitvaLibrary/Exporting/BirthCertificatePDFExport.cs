...
public static class BirthCertificatePDFExport
{
    ...
    /// </summary>
    public static MemoryStream GenerateBirthCertificate(BirthCertificateModel certificate, MunicipalityModel municipality, UserModel user)
    {
    ...
    /// </summary>
    private static string GenerateCertificateId(BirthCertificateModel certificate, UserModel user)
    {
    ...
    /// </summary>
    public static string GenerateFileName(BirthCertificateModel certificate, UserModel user)
    {
    ...
    /// </summary>
    private static float DrawEnhancedCertificationSection(Syncfusion.Pdf.PdfPage page, float currentY, MunicipalityModel municipality, BirthCertificateModel certificate)
    {
        var graphics = page.Graphics;
        var pageSize = page.GetClientSize();
    ...
    /// </summary>
    private static void DrawEnhancedCertificateFooter(Syncfusion.Pdf.PdfPage page, float currentY, string certificateId, BirthCertificateModel certificate)
    {
        var graphics = page.Graphics;
        var pageSize = page.GetClientSize();
    ...
    /// </summary>
    private static string GenerateVerificationCode(BirthCertificateModel certificate)
    {
