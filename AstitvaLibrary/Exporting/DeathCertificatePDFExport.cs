...
public static class DeathCertificatePDFExport
{
	...
	/// </summary>
	public static MemoryStream GenerateDeathCertificate(DeathCertificateOverviewModel certificate, UserModel user)
	{
	...
	/// </summary>
	private static string GenerateCertificateId(DeathCertificateOverviewModel certificate, UserModel user)
	{
	...
	/// </summary>
	public static string GenerateFileName(DeathCertificateOverviewModel certificate, UserModel user)
	{
	...
	/// </summary>
	private static float DrawEnhancedCertificationSection(Syncfusion.Pdf.PdfPage page, float currentY, DeathCertificateOverviewModel certificate)
	{
		var graphics = page.Graphics;
		var pageSize = page.GetClientSize();
	...
	/// </summary>
	private static void DrawEnhancedCertificateFooter(Syncfusion.Pdf.PdfPage page, float currentY, string certificateId, DeathCertificateOverviewModel certificate)
	{
		var graphics = page.Graphics;
		var pageSize = page.GetClientSize();
	...
	/// </summary>
	private static string GenerateVerificationCode(DeathCertificateOverviewModel certificate)
	{
