...
public class UpdateService : IUpdateService
{
	...
	{
#if ANDROID
		return await Astitva.Services.Android.AadiSoftUpdater.CheckForUpdates(githubRepoOwner, githubRepoName, currentVersion);
#else
	...
	{
#if ANDROID
		await Astitva.Services.Android.AadiSoftUpdater.UpdateApp(githubRepoOwner, githubRepoName, setupAPKName, progress);
#else
		await Task.CompletedTask;
#endif
	}
